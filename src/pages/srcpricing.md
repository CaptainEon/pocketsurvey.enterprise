...
content_blocks:
  ...
  - _type: components/left-right
    ...
    text:
      markdown_content: >-
        Designed for housing associations, local councils, surveying practices, and commercial FM teams requiring rigorous compliance standards and enterprise database controls. Free onboarding & support included.


        ### Housing Stock Condition Suite
        * **Decent Homes Standard:** Complete mobile auditing for social housing standards.
        * **SHQS & WHQS:** Dedicated modules for Scottish and Welsh Housing Quality Standards.
        * **HHSRS Audits:** Track damp, mould, and tenant safety hazards seamlessly.
        ...
        * **30–50 Year CapEx Forecasting:** Automated financial replacement schedules.
      color: '#334155'
    image:
  ...
  - _type: components/left-right
    ...
    text:
      markdown_content: >-
        PocketSurvey collects practical onsite mobile data and generates pre-formatted CSV exports ready for direct import into your core corporate property database.
  ...
  - _type: components/left-right
    ...
    text:
      markdown_content: >-
        ...
        * **Custom Inspection Logic:** Tailored fields, scoring matrices, and conditional branching.
        * **Bespoke Data Exporters:** Custom-coded CSV, XML, or JSON exports matching your schema.
        * **Branded Deliverables:** Custom PDF report templates styled to your corporate guidelines.
      color: '#334155'
    image:
      image_path: /assets/images/undraw-startup.svg
